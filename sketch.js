...
var info = ["The Earth is born",
            ...
            "Fishes start to fill the waters",
            "Life came from the ocean to land",
            "Insects and vegetation start to flourish",
            ...
            "Dinosaurs became the overlord of the earth",
...
function title(){
    ...
    textLeading(24);
    textStyle(ITALIC);
    text("Feel the timeflow of life evolution \nwith your mouse ",width/6-150,height/2-150);
    // textStyle(NORMAL);
    textLeading(20);
    textStyle(BOLD);
    fill("WHITE");
    text("Click to start your journey",width/6-150,height/2-25);
...
function stop(){
  ...
  text("THE FASTER YOU'LL MOVE, THE MORE TIME YOU'LL PASS",width/6+9500,height/2);
  text("WHEN YOU ENTER THE NEXT STAGE OF LIFE, THE COLOR OF THE TIMELINE CHANGES",width/6+20000,height/2);
  text("YOU CAN PRESS THE LEFT ARROW KEY WHILE MOVING THE MOUSE TO GO BACK" , width/6+30000,height/2);
  ...
  //1240 simple cell
  text("THE ROOT OF THE TREE OF LIFE IS A MONOPHYLETIC DOMAIN BACTERIA",width/6+100000,height/2);
  // now we need 15 text // 1560
  text("LUCA: THE LAST UNVERSAL COMMON ANCESTOR, IS THE MOST RECENT COMMON ANCESTOR OF ALL CURRENT LIFE ON EARTH",width/6+130000,height/2);
  //1880
